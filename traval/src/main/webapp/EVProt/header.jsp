...
<div class="w3-bar w3-top w3-black w3-large" 
 ...
 <span class="w3-animate-left applogout">
    ...
    <a href="<%=commonMaster.getStartFileURL()%>core_team.png" style="text-decoration: none;" target="_new"></a> &nbsp; 
    <a href="<%=commonMaster.getStartFileURL()%>know_your_approvers.pptx" style="text-decoration: none;" target="_new"></a> &nbsp; 
    <a href="<%=commonMaster.getStartFileURL()%>ecrn_testers_manual.ppsx" style="text-decoration: none;" target="_new"></a> &nbsp; 
    <a href="<%=commonMaster.getStartFileURL()%>ecrn_user_tester_manual.pdf" style="text-decoration: none;" target="_new"></a></span> 
