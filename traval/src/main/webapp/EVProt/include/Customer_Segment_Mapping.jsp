...
<body>
   ...
   <option value="Yanmar"> Yanmar</option>
           ...
           <td> <select name="Cluster" id="Cluster">


            <option value="Dont">Don't Exist</option>
            <option value="Minimal">Minimal Existance</option>
            <option value="Good">Good SOB</option>
            </select>
